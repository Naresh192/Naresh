<html>
  ...
  duration: 800
	...
	<input type="text" id="ca" name="ca" placeholder="Enter The Category No."></input>
	<input type="submit" value="Submit" style="height:5%;width:25%;position:static;font-size:15px;"></input>
	</form>
	<form method="post" action="rec3.php">
	<h3>Search by Name</h3>
	<input type="text" id="ca" name="na" placeholder="Enter The Name"></input>
	<input type="submit" value="Submit" style="height:5%;width:25%;position:static;font-size:15px;"></input>
	</form>
	</div>
	<input type="button" value="Go To Home"></input>
	<?php 	
		$b=$_POST['na'];
		 $numbers[0] = "Art & Literature";
		...
		$sql="SELECT * FROM `attempts` WHERE no='$b';";
